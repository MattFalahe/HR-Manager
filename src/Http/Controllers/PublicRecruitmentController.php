...
class PublicRecruitmentController extends Controller
{
    ...
    {
        // Single source of truth lives on SeatConnectorService now (shared with
        // the public tracking page's "link your Discord" nudge).
        return app(SeatConnectorService::class)->identitiesUrl();
    }
