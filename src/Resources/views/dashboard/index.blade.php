...
<div class="hr-manager-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            {{-- bg-gradient-warning is a bright amber; AdminLTE forces white
                 text/icon on info-boxes, which is unreadable here. Inline dark
                 text (beats the class colour without needing a CSS republish). --}}
            <div class="info-box bg-gradient-warning" style="color: #1f2d3d !important;">
                <span class="info-box-icon" style="color: #1f2d3d !important;"><i class="fas fa-search"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text" style="color: #1f2d3d !important;">{{ trans('hr-manager::dashboard.under_review') }}</span>
                    <span class="info-box-number" style="color: #1f2d3d !important;">{{ $stats['under_review'] }}</span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
