    ...
    <div class="diag-body">
        ...
        @if($activeTab === 'health')
            <div class="diag-tab-intro">
                ...
                <strong>When to use:</strong> first stop when something looks broken.
                <strong>Heads up:</strong> WARN is usually "optional thing absent" (e.g. Manager Core not installed); FAIL means a hard dependency is missing.
            </div>
        ...
        @elseif($activeTab === 'validation')
            <div class="diag-tab-intro">
                ...
                <strong>When to use:</strong> when CWM/MM/Broadcast data isn't flowing, or after a Manager Core upgrade.
                <strong>Heads up:</strong> a published-topic FAIL means a publish site outran the MC registry.
            </div>
        ...
        @elseif($activeTab === 'settings')
            <div class="diag-tab-intro">
                ...
                <strong>When to use:</strong> after editing settings, or when notifications/recruitment behave unexpectedly.
                <strong>Heads up:</strong> a non-HTTPS webhook FAIL means that webhook will be rejected at send time.
            </div>
            <div class="card card-dark mb-0">
        ...
        @elseif($activeTab === 'integrity')
            <div class="diag-tab-intro">
                ...
                <strong>When to use:</strong> when the dashboard looks stale or empty, to tell "no data yet" from "a job hasn't run."
                <strong>Heads up:</strong> a stale classifier WARN usually means the nightly cron hasn't run.
            </div>
            <div class="card card-dark mb-0">
        ...
        @elseif($activeTab === 'notifications')
            <div class="diag-tab-intro">
                ...
                <strong>When to use:</strong> after setting up a webhook, or when alerts aren't arriving.
                <strong>Heads up:</strong> this posts a live message to the channel.
            </div>
            @if($webhooks->isEmpty())
        ...
        @elseif($activeTab === 'trace')
            <div class="diag-tab-intro">
                ...
                <strong>When to use:</strong> when one application behaved oddly (stuck status, missing handler, no event).
                <strong>Heads up:</strong> read-only; it changes nothing.
            </div>
