...
return [
    ...
    'track_discord_step_heading' => 'Link your Discord',
    'track_discord_step_body'    => 'You have not linked your Discord account yet. Connect it through SeAT so we can give you the right roles when you are accepted.',
    'track_discord_step_btn'     => 'Link Discord',
    ...
    'withdraw_reason_label'       => 'Reason for withdrawing',
    'withdraw_reason_optional'    => 'optional',
    'withdraw_reason_placeholder' => 'Let the recruiters know why you\'re withdrawing (optional).',
    'withdraw_reason_required'    => 'Please give a reason for withdrawing your application.',
