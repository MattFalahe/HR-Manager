...
return [
    ...
    'feat_p_cap_6' => '<strong>Squad cleanup</strong>: the player profile lists the account\'s SeAT squad memberships and offers a one-button <em>Remove from all squads</em>. It mirrors SeAT\'s native kick, so when SeAT Connector is installed the matching Discord roles drop immediately; without Connector it just clears the SeAT squad membership. Director-only, recorded on the history timeline.',
