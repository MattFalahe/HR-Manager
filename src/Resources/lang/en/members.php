...
return [
    ...
    'roster_evewho_heading'  => 'Roster filled from EveWho',
    'roster_evewho_body'     => 'SeAT has no Director token for this corp, so :count character(s) were back-filled from EveWho\'s public corp list (fetched :when). EveWho is a third-party aggregator — it can list departed members and miss recent joins, and these rows are name-only. For the authoritative roster, add a Director token with the read_corporation_membership scope under Seat → Settings → API → Refresh tokens.',
    'source_evewho'          => 'EveWho',
    'source_evewho_help'     => 'Listed via EveWho\'s public corp roster, not SeAT — name-only and may be out of date.',
    'no_seat_page'           => 'Not in SeAT',
    'no_seat_page_help'      => 'SeAT has no record of this character (it\'s only in the EveWho list), so there is no profile page to open. It gains one once it authenticates or SeAT otherwise syncs it.',
    ...
    // SeAT native-page deep links (director convenience)
    'seat_links_heading'  => 'View in SeAT',
    'seat_links_footnote' => 'Opens SeAT\'s own character pages in a new tab. Access is governed by your existing SeAT permissions — HR attaches no extra grant here (unlike recruiter access on applications).',
    'seat_link_sheet'     => 'Sheet',
    'seat_link_wallet'    => 'Wallet',
    'seat_link_mail'      => 'Mail',
    'seat_link_assets'    => 'Assets',
    'seat_link_skills'    => 'Skills',
