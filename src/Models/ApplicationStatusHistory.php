...
class ApplicationStatusHistory extends Model
{
    ...
    /** The director who voided this transition (a correction of a mistake). */
    public function voider()
    {
        return $this->belongsTo(\Seat\Web\Models\User::class, 'voided_by');
    }

    /** A voided transition is a correction: kept internally, hidden from the applicant. */
