...
class WebhookConfiguration extends Model
{
    ...
    protected $fillable = [
        ...
        'notify_silent_wallet_director',
        'notify_handler_note',
        'notify_dead_weight',
        'notify_purge_reminder',
        'notify_player_status',
        'notify_loa_marked',
        'notify_marked_for_purge',
        'notify_status_cleared',
        'notify_purge_personal',
        'notify_token_revoked',
        'notify_token_coverage',
        ...
        'notify_onboarding_welcome',
        'notify_flagged_applicant',
        'discord_role_id',
        'discord_username',
        'slack_channel',
        'slack_username',
    ...
    protected $casts = [
        ...
        'notify_silent_wallet_director' => 'boolean',
        'notify_handler_note'           => 'boolean',
        'notify_dead_weight'            => 'boolean',
        'notify_purge_reminder'         => 'boolean',
        'notify_player_status'          => 'boolean',
        'notify_loa_marked'             => 'boolean',
        'notify_marked_for_purge'       => 'boolean',
        'notify_status_cleared'         => 'boolean',
        'notify_purge_personal'         => 'boolean',
        'notify_token_revoked'          => 'boolean',
        'notify_token_coverage'         => 'boolean',
        ...
        'notify_join_no_application'    => 'boolean',
        'notify_member_unregistered'    => 'boolean',
        'notify_onboarding_welcome'     => 'boolean',
        'notify_flagged_applicant'      => 'boolean',
