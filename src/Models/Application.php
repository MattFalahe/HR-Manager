...
class Application extends Model
{
    ...
    /**
     * Applicant-facing status timeline: excludes voided rows (transitions a
     * director marked as an accidental mistake), so the public tracking page
     * shows a clean progression while the full history is preserved internally.
     */
    public function publicStatusHistory()
    {
        return $this->hasMany(ApplicationStatusHistory::class, 'application_id')
            ->whereNull('voided_at')
            ->orderBy('created_at', 'desc');
