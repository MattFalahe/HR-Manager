...
class PlayerStatus extends Model
{
    ...
    // How a purge was created. Only ORIGIN_TOKEN_LOSS purges are eligible for
    // the Token-loss Watchdog's auto-cancel on token restore; a director's
    // manual purge (ORIGIN_MANUAL) is never touched by the automation.
    public const ORIGIN_MANUAL     = 'manual';
    public const ORIGIN_TOKEN_LOSS = 'token_loss';
